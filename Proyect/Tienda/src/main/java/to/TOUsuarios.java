...
public class TOUsuarios {
   ...
   private String ciudadDomicilio;
    ...
    public TOUsuarios(int idUsuarios, String nombreUsuario, String clave, String rolUsuario, String nombres, String apellidos, String genero, String fechaNacimiento, String tipoIdentificacion, String numeroIdentificacion, String direccion, String telefono, String correoPersonal, String ciudadDomicilio) {
        this.idUsuarios = idUsuarios;
        this.nombreUsuario = nombreUsuario;
        this.clave = clave;
        this.rolUsuario = rolUsuario;
